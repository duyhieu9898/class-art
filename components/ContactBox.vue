<template>
  <nav
    class="flex justify-around px-4 py-6 max-w-4xl mx-auto text-sm flex-col md:flex-row"
  >
    <ul class="px-6 font-medium" style="list-style-type: square">
      <li class="py-1"><span class="font-bold">Liên hệ: </span></li>
      <li class="py-1">
        <span
          >Facebook:
          <a href="https://www.facebook.com/refstudiodn" target="_blank"
            >Refadcademy - Đà Nẵng</a
          ></span
        >
      </li>
      <li class="py-1">
