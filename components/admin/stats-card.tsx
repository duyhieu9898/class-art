...
export function StatsCard({ label, value, icon, description, variant = "primary" }: StatsCardProps) {
    ...
    return (
        <Card className="hover:shadow-md hover:border-gray-300 transition-all duration-200 group cursor-pointer">
            <CardContent className="p-6">
                <div className="flex items-center justify-between">
                    ...
                    {icon && (
                        <div className={`p-3 rounded-xl border ${iconBgColor} transition-all group-hover:scale-110 duration-200`}>
