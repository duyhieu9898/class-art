    ...
    return (
        <div className="flex min-h-screen flex-col">
            ...
            <main className="flex-1 px-5">
                {/* Hero - Sứ mệnh */}
                <section className="relative mx-auto mt-10 h-[550px] md:h-[785px] w-full max-w-[1600px] overflow-hidden rounded-[20px] ">
                    <Image
                    ...
                    <div className="absolute inset-y-0 left-0 flex w-full md:w-[35%] items-center rounded-l-[20px] bg-[rgba(24,24,24,0.85)]">
                        <div className="space-y-6 p-6 md:p-10 text-white">
                            <div>
                ...
                <section className="w-full py-8 md:py-16">
                    <div className="mx-auto max-w-[1600px] ">
                        ...
                        <div className="relative z-10 -mt-20 rounded-xl bg-white p-4 md:p-8 shadow-lg">
